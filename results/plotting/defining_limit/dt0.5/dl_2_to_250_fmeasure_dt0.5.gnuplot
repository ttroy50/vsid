set terminal svg size 500,240 fname "Gill Sans" fsize 9 rounded dashed
...
set output "dl_2_to_250_fmeasure_dt0.5.svg"
set xlabel "Defining Limit"
set ylabel "F-Measure" offset 2.75,2
...
plot "../results/plotting/defining_limit/dt0.5/dl_2_to_250_fmeasure_dt0.5.data" \
