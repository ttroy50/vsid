...
src/pcap_classifier/src/vsid_pcap_classifier -c ../config/config_pcap_classifier.yaml -p /media/matrim/toshiba/College/project/classification/DNS//dns_home.pcap
